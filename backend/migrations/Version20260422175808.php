 ...
 */
final class Version20260422175808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cancellation_policies CHANGE rules_json rules_json JSON NOT NULL');
        ...
        $this->addSql('ALTER TABLE organizer_profiles CHANGE license_number license_number VARCHAR(100) DEFAULT NULL, CHANGE website website VARCHAR(255) DEFAULT NULL, CHANGE facebook facebook VARCHAR(255) DEFAULT NULL, CHANGE instagram instagram VARCHAR(255) DEFAULT NULL, CHANGE documents documents JSON DEFAULT NULL');
        $this->addSql('ALTER TABLE payments ADD stripe_payment_intent_id VARCHAR(255) DEFAULT NULL, ADD refund_id VARCHAR(255) DEFAULT NULL, ADD refund_amount NUMERIC(10, 2) DEFAULT NULL, ADD dispute_id VARCHAR(255) DEFAULT NULL, ADD dispute_status VARCHAR(50) DEFAULT NULL, CHANGE transaction_ref transaction_ref VARCHAR(100) DEFAULT NULL, CHANGE paid_at paid_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE reviews CHANGE status status VARCHAR(20) DEFAULT \'pending\' NOT NULL, CHANGE response_date response_date DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bookings CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE cancellation_policies CHANGE rules_json rules_json LONGTEXT NOT NULL COLLATE `utf8mb4_bin`');
        $this->addSql('ALTER TABLE destinations CHANGE region region VARCHAR(100) DEFAULT \'NULL\', CHANGE image image VARCHAR(500) DEFAULT \'NULL\', CHANGE thumbnail thumbnail VARCHAR(500) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE messenger_messages CHANGE delivered_at delivered_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE organizer_profiles CHANGE license_number license_number VARCHAR(100) DEFAULT \'NULL\', CHANGE website website VARCHAR(255) DEFAULT \'NULL\', CHANGE facebook facebook VARCHAR(255) DEFAULT \'NULL\', CHANGE instagram instagram VARCHAR(255) DEFAULT \'NULL\', CHANGE documents documents LONGTEXT DEFAULT NULL COLLATE `utf8mb4_bin`');
        $this->addSql('ALTER TABLE payments DROP stripe_payment_intent_id, DROP refund_id, DROP refund_amount, DROP dispute_id, DROP dispute_status, CHANGE transaction_ref transaction_ref VARCHAR(100) DEFAULT \'NULL\', CHANGE paid_at paid_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE reviews CHANGE status status VARCHAR(20) DEFAULT \'\'\'pending\'\'\' NOT NULL, CHANGE response_date response_date DATETIME DEFAULT \'NULL\'');
